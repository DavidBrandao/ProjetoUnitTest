...
class LinkTest {
    ...
    void testToString() {
        Link link = new Link(cidade1, cidade2, tamanho);
        assertEquals(stringDesejadaLink, link.toString());
    }

    @Test
    void testToStringInvertido(){
        Link link = new Link(cidade1, cidade2, tamanho);
        assertNotEquals(stringDesejadaLinkInvertido, link.toString());
    }
    ...
    void testCompareToCidadesDiferentesNegativo() {
        ...
        assertEquals(-1, link.compareTo(link2));
    }
